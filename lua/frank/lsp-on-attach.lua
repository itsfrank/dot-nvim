...
return function(client, bufnr)
    ...
    keymap_set("n", "<leader>ws", snacks.picker.lsp_workspace_symbols, "[W]orkspace [S]ymbols")
    ...
    if client.name == "clangd" then
        ...
        keymap_set("n", "<leader>ch", ":LspClangdSwitchSourceHeader<cr>", "[C]langd switch source [H]eader")
    end
